...
public class ConnectorUtils {
  ...
  public static final String GCP_SA_CREDENTIALS_FILE_PATH_CONFIG = "gcp.credentials.file.path";
  public static final String GCP_SA_CREDENTIALS_JSON_CONFIG = "gcp.credentials.json";
