...
public class CloudPubSubSinkConnector extends SinkConnector {
  ...
  public enum OrderingKeySource {
    ...
    /** Validator class for {@link OrderingKeySource}. */
    public static class Validator implements ConfigDef.Validator {

      @Override
      public void ensureValid(String name, Object o) {
        String value = (String) o;
        if (!value.equals(OrderingKeySource.NONE.toString())
            && !value.equals(OrderingKeySource.KEY.toString())
            && !value.equals(OrderingKeySource.PARTITION.toString())) {
  ...
  public void start(Map<String, String> props) {
    ...
    // Extract and log metrics-related overrides
    ...
    metricKeys.forEach(key -> {
      ...
      if (v != null) { overrides.put(key, v); }
    });
    log.info("Configuring MetricsRegistry with overrides: {}", overrides);
    MetricsRegistry.configure(overrides);
    MetricsRegistry.get(); // Init MeterRegistry
